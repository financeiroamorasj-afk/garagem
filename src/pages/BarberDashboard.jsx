...
function SaleModal({ product, appointments, form, setForm, error, busy, onClose, onSubmit }) {
  ...
  const total = Number(product.preco_venda) * Number(form.quantidade || 0)

  function submit(event) {
    if (form.formaPagamento === 'pix' && !pixReady) {
