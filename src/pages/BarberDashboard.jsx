...
export default function BarberDashboard() {
  ...
  return <div className="min-h-dvh overflow-x-hidden bg-surface-0 pb-24 text-warm-white sm:pb-8">
    ...
    <CutCompletionModal open={Boolean(completionTarget)} appointment={completionTarget} onClose={() => !busyId && setCompletionTarget(null)} onSuccess={async () => { setCompletionTarget(null); setNotice('Atendimento concluído e memória do corte salva.'); await loadDay({ quiet: true }) }} />
