...
const ReceptionBoard = () => {
    ...
    return (
        <div className="h-screen w-screen flex flex-col bg-[#121212] text-white overflow-hidden">
            ...
            <nav className="h-20 border-b border-gray-800 bg-[#161616] flex items-center justify-between px-8 shrink-0">
                <div className="flex items-center space-x-4">
                    <div className="bg-copper p-2 rounded-lg">
                        <Calendar className="text-white" size={24} />
                    </div>
                    <div>
                        <h1 className="text-xl font-black uppercase tracking-tighter text-copper">Quadro de Recepção</h1>
                        <p className="text-[10px] text-gray-500 font-bold uppercase tracking-widest leading-none">Visão da Unidade • TV Mode</p>
                    </div>
                </div>
                ...
                <div className="hidden md:flex items-center space-x-8">
                    <div className="text-right">
                        <div className="text-xs font-bold text-gray-500 uppercase tracking-widest">Data</div>
                        <div className="text-xl font-black text-white">{new Date().toLocaleDateString('pt-BR')}</div>
                    </div>
                    <div className="bg-gray-800/50 p-2 rounded-full text-gray-400 hover:text-copper cursor-pointer relative">
                        <Bell size={20} />
                        <span className="absolute top-1 right-1 w-2 h-2 bg-copper rounded-full border-2 border-[#161616]"></span>
                    </div>
                </div>
            </nav>
            ...
            <div className="flex-1 flex overflow-hidden">
                {/* Sidebar slim */}
                <aside className="w-16 border-r border-gray-800 bg-[#161616] flex flex-col items-center py-8 space-y-8 shrink-0">
