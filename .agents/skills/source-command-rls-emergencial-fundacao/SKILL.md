---
name: "source-command-rls-emergencial-fundacao"
...
# source-command-rls-emergencial-fundacao

Use this skill when the user asks to run the migrated source command `rls-emergencial-fundacao`.
