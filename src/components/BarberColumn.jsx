    ...
    return (
        <div className="flex-shrink-0 w-80 h-full flex flex-col bg-surface-2 border-r-2 border-r-copper/50 last:border-r-0 shadow-[-5px_0_15px_-5px_rgba(0,0,0,0.5)] relative overflow-hidden group">
            ...
            <div className="p-4 border-b-2 border-b-copper/30 bg-black/20 flex items-center justify-between backdrop-blur-sm sticky top-0 z-10">
                <h3 className="text-h2 text-gold-aged uppercase drop-shadow-md truncate">
                    {professional.nome}
                </h3>
            ...
            <div className="flex-1 overflow-y-auto p-2 space-y-2 custom-scrollbar">
                {appointments.length === 0 ? (
                    ...
                    <div className="p-4 text-center text-steel text-label border border-dashed border-line rounded-sm mt-4">
                        Sem agendamentos
                    </div>
                ) : (
            ...
            {/* Footer/Actions */}
            <div className="p-3 border-t border-line bg-black/20">
                <Button
                    variant="secondary"
                    size="sm"
                    className="w-full"
