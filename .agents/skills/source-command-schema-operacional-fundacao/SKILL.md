---
name: "source-command-schema-operacional-fundacao"
...
# source-command-schema-operacional-fundacao

Use this skill when the user asks to run the migrated source command `schema-operacional-fundacao`.
