...
export default function ReceptionProductSaleModal({ open, onClose, onSuccess }) {
  ...
  async function submit(event) {
    ...
    try {
      ...
      if (paymentMethod === 'pix' && !pixReady) throw new TypeError('Configure e gere o PIX antes de confirmar a venda.')
